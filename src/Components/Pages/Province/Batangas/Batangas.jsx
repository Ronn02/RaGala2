...
const Batangas = () => {
    ...
    return (    
        <div className="w-full min-h-screen">
            <PCNavBar></PCNavBar>
            <div className='  h-[75vh] w-full flex justify-center items-center' ><img src={Batangas1} alt="" className="object-cover h-[100vh] w-full" />
            <div className="absolute top-0 left-0 h-[102vh] md:h-[100vh] w-full flex flex-col justify-center items-center text-white bg-black bg-opacity-20">
                ...
                <a href="#places" className='text-l md:text-2xl mt-[50px]'> View Destinations</a>
                
            </div>
            </div>


            <div className=' h-[50px] md:h-[150px]' id='places'>
